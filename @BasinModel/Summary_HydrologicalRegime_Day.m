function Summary_HydrologicalRegime_Day(obj, varargin)
% -------------------------------------------------------------------------
% Matlab - R2018b 
% -------------------------------------------------------------------------
%                           Informaci�n Basica
...
%     colorbar off
    ...
    title('\bf Curva de duraci\''on de caudales medios d\''iarios','Interpreter','latex','FontSize',25,'Color',obj.ColorsF('jasper'))
...
%             ['\bf Caudal Ambiental = ', num2str(QAmb,'%0.2f')],  'interpreter', 'latex', 'fontsize',13)
    ...
    ylabel('\bf Caudal $\bf {(m^3/s)}$','Interpreter','latex','FontSize',18)
    title('\bf Serie de tiempo de caudales medios d\''iarios','Interpreter','latex','FontSize',25,'Color',obj.ColorsF('jasper'))
    set(gca, 'TickLabelInterpreter','latex','FontSize',15,'linewidth',2,'Color','none','box','off') 
