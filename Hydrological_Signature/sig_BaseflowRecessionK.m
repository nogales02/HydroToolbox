function [BaseflowRecessionK, error_flag, error_str, Fig] = ...
...
[flow_section, error_flag, error_str, Fig] = util_RecessionSegments(Q, t, ...
...
if plot_results   
    ...
    xlabel('\bf Relative time ${\bf [timestep]}$','Interpreter','latex','FontSize',16)
    ylabel('\bf Flow ${\bf [mm/timestep]}$','Interpreter','latex','FontSize',16)
    title('\bf Fitted recession curve','Interpreter','latex','FontSize',18)
    ln = legend('MRC','Exponential fit');
    set(gca, 'TickLabelInterpreter','latex', 'FontWeight','bold','Color','none', 'box','on','FontSize',14)       
    set(ln, 'interpreter','latex','FontSize',10)
    ...
    xlabel('\bf Relative time ${\bf [timestep]}$','Interpreter','latex','FontSize',16)
    ylabel('\bf Flow ${\bf [mm/timestep]}$','Interpreter','latex','FontSize',16)
    title('\bf Fitted recession curve - log scale','Interpreter','latex','FontSize',18)
    ln = legend('MRC','Exponential fit');
    set(gca, 'TickLabelInterpreter','latex', 'FontWeight','bold','Color','none', 'box','on','FontSize',14)    
    set(ln, 'interpreter','latex','FontSize',10)
