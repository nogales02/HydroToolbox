function [Qs,inter,param] = MD_SACRAMENTO(obj, x, P, E, Qb, Area, states)
%
...
% param -->
% .x(1) = capacité uzfwm [10 75]
% .x(2) = capacité uztwm [25 125]
...
% .x(9) = délai
%
% .x (1) = uzfwm capacity [10 75]
% .x (2) = uztwm capacity [25,125]
% .x (3) = emptying constant of the underground tank []
% .x (4) = percolation coefficient []
% .x (5) = infiltration constant []
% .x (6) = drain constant of the hypodermic flow []
% .x (7) = pfree partition coefficient []
% .x (8) = coefficient of deep percolations []
% .x (9) = delay
%
...
if isempty(states)
    ...
    param.L = states.L;
    param.M = states.M;
    param.XF1 = states.XF1;
    param.XF2 = states.XF2;
end
