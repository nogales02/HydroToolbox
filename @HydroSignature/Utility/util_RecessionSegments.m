function [flow_section, error_flag, error_str, Fig] = ...
...
if plot_results
    ...
    hold on;
    title('\bf Selected recession segments','Interpreter','latex','FontSize',18)
    ...
    ln = legend('Streamflow','Recessions');
    set(ln, 'interpreter','latex','FontSize',10)
    xlabel('\bf Date','Interpreter','latex','FontSize',16)
