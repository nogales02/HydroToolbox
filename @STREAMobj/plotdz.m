function [Fig, d,z] = plotdz(S,DEM,varargin)
...
xlabel(['\bf Distancia Aguas Arriba [' lower(p.Results.dunit) ']'],'interpreter', 'latex','fontsize',20)
ylabel('\bf Elevac\''ion [m]', 'interpreter', 'latex','fontsize',20)
title('\bf Perfil Red de Dreanaje ', 'interpreter', 'latex', 'fontsize',25)
