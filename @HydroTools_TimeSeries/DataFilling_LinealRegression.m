function DataFilling_LinealRegression(obj,varargin)
% -------------------------------------------------------------------------
% Matlab - R2018b 
% -------------------------------------------------------------------------
%                           Informaci?n Basica
...
for ii = 1:length(PoPo) 
    try
        ...
        disp([num2str((i/length(obj.Code))*100,'%.2f') ,'% -> Ok Complect Kriging-Lineal-Regressition for Gauges ->',num2str(obj.Code(PoPo(ii)))]) 
