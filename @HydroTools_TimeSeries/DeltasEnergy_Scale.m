function DeltasEnergy_Scale(obj,varargin)
...
%         Results = sum(ds,'omitnan')';        
        ...
        if obj.StatusPlot
            ...
            title(['log(f($\delta$t)) = log(',num2str(Params(2),'%.2f'),') - ',num2str(Params(1),'%.4f'),'*$\delta$t'],'interpreter','latex', 'Fontsize',20)
