...
% since start of water year (default: June) reaches (here: exceeds) a 
% quarter of the annual discharge and the date on which the cumulative 
% discharge since start of water year (default: June) reaches three 
...
%   OPTIONAL
%   start_water_year: first month of water year, default = 6 (June)
%
%   OUTPUT
...
addParameter(ip, 'start_water_year', 6, validationFcn) % when does the water year start? Default: 6
